package datatofromapachespark.utils
...
object GetAllProperties {
    ...
    private var properties  = Map[String, String]()
      ...
      def readPropertyFile(): Map[String, String] = {
        ...
        prop.load(new FileInputStream(s"C://Users//${userName}//intelliJProjects//datatofromapachespark//src//main//resources//app.properties"))
